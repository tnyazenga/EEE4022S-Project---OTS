...
while(row<1000):
    ...
    if ret == True:
        ...
        if retval:
            ...
            #cv2.waitKey(5000)
            worksheet.write(row, col, bx)
            worksheet.write(row, col + 1, by)
            worksheet.write(row, col + 2, bz)
            worksheet.write(row, col + 3, roll)
            worksheet.write(row, col + 4, pitch)
            worksheet.write(row, col + 5, yaw)
            row += 1
